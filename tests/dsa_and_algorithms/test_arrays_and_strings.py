...
def test_arrays_are_equal(input_array_1: List[int], input_array_2: List[int], expected: bool) -> None:
...
def test_no_repeated_chars(input_string: str, expected: int) -> None:
    assert no_repeated_chars(input_string) == expected
...
def test_smallest_substring(input_string_1: str, input_string_2: str, expected: str) -> None:
    assert smallest_substring(input_string_1, input_string_2) == expected
